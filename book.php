...
<div class="heading" style="background:url(/RTP/images/header-3.png) no-repeat">
    <h1 Style=" font-size: 10rem;text-transform: uppercase;color: var(--white);text-shadow: var(--text-shadow)";>Book Now</h1>
</div>
   ...
   <form action="book_form.php" method="post" class="book-form">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="select from this (Car, Bus, Minivan, Cruiseship)" name="transportation">
         </div>
      </div>
